...
async function createRuntimeSmokeModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('runtime-smoke.generated.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('runtime-smoke.generated.wasm', import.meta.url).href;
...
export default createRuntimeSmokeModule;
