...
async function createFlowRuntimeModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('runtime-catalog-node.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('runtime-catalog-node.wasm', import.meta.url).href;
...
var _pp_wasm_catalog_json = Module['_pp_wasm_catalog_json'] = makeInvalidEarlyAccess('_pp_wasm_catalog_json');
var _pp_wasm_run_graph_json = Module['_pp_wasm_run_graph_json'] = makeInvalidEarlyAccess('_pp_wasm_run_graph_json');
var _pp_wasm_last_result_json = Module['_pp_wasm_last_result_json'] = makeInvalidEarlyAccess('_pp_wasm_last_result_json');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['pp_wasm_catalog_json'] != 'undefined', 'missing Wasm export: pp_wasm_catalog_json');
  assert(typeof wasmExports['pp_wasm_run_graph_json'] != 'undefined', 'missing Wasm export: pp_wasm_run_graph_json');
  assert(typeof wasmExports['pp_wasm_last_result_json'] != 'undefined', 'missing Wasm export: pp_wasm_last_result_json');
  ...
  _pp_wasm_catalog_json = Module['_pp_wasm_catalog_json'] = createExportWrapper('pp_wasm_catalog_json', 0);
  _pp_wasm_run_graph_json = Module['_pp_wasm_run_graph_json'] = createExportWrapper('pp_wasm_run_graph_json', 2);
  _pp_wasm_last_result_json = Module['_pp_wasm_last_result_json'] = createExportWrapper('pp_wasm_last_result_json', 0);
...
export default createFlowRuntimeModule;
