...
assert.deepStrictEqual(
    ...
    { type: 'navigate', href: 'flow-builder/' }
);
...
assert.doesNotMatch(fullyOpenDetailDefinition, /:::nodeLaneImu\b/);
assert.doesNotMatch(fullyOpenDetailDefinition, /:::nodeLaneDsp\b/);
assert.doesNotMatch(fullyOpenDetailDefinition, /:::nodeLaneBle\b/);
...
assert.match(fullyOpenDetailDefinition, /nodeDspFlow/);
